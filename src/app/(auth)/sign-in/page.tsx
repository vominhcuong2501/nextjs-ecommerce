...
// import { useModifyObject, useReverseModifyObject } from '@/lib/utils/modifyContent'
...
// 			const dataRememberConvert = useReverseModifyObject(JSON.parse(dataRememberGetCookie), false)
...
// 		remember ? setCookie('__remember', dataRememberCookie) : deleteCookie('__remember')

// 		setIsLoading(true)
// 		try {
// 			const responseSignIn = await submitSignInApi(formDataLogin)
...
// 				const expirationTime = new Date(currentTime.getTime() + 7 * 24 * 60 * 60 * 1000)
...
// 			<h1 className='text-30 font-bold leading-1-4 text-neutral-1 text-center'>Nice to see you!</h1>
...
// 						<Switch onChange={handleRemember} className='bg-neutral-7' size='small' />
// 						<p className='text-14 font-normal text-neutral-1 leading-1-4'>Remember me!</p>
// 					</div>
// 					<Button isLoading={isLoading} disabled={!isValid || isLoading} onClick={(e) => handleFormSubmit(e)}>
// 						Sign In
// 					</Button>
// 				</form>
...
// 						<span className='text-neutral-1 font-semibold underline hover:no-underline ml-1'>Sign up</span>
// 					</Link>
// 				</div>
// 			</div>
// 		</div>
