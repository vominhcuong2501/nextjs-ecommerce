			...
			<div className='hidden md:block'>
				<div className='sticky top-0 '>
					...
					>
						...
						<h3 className='text-neutral-1 text-16 font-semibold leading-1-4'>Need Help?</h3>
						<p className='text-neutral-1 text-14 font-semibold leading-1-4 mb-5'>Please check our docs</p>
						<Link
			...
			<div className='flex-1 z-10'>
				<div className='fixed top-0 left-0 w-full z-50 px-3 py-2 md:px-0 md:py-0 backdrop-blur-2xl bg-gradient-to-b from-[#7fe2f3] to-[#5f88c9]'>
					<div className='flex items-center justify-between md:hidden '>
						...
						<div className='border border-neutral-1 rounded-lg cursor-pointer' onClick={() => setIsShow(true)}>
							<svg
								width='44'
								height='44'
								viewBox='0 0 44 44'
