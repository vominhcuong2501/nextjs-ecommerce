	...
	return (
		...
		>
			<p className='h-5 w-5 flex flex-col justify-around items-center bg-transparent border-none p-0 cursor-pointer focus:outline-none '>
				<span
					className={`group-hover:bg-orange-11 block w-full h-0.5 bg-neutral-9 transform transition duration-200 ease-in-out ${
						isShowSidebarMenu ? 'rotate-45 translate-y-[6.8px]' : ''
					}`}
				></span>
				<span
					className={`group-hover:bg-orange-11 block w-full h-0.5 bg-neutral-9 transition-all duration-200 ease-in-out ${
