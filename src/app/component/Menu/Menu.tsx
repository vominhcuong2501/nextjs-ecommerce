			...
			<div className='max-w-[1360px] mx-auto '>
				<div className='flex items-center justify-between'>
					<ul className={` flex items-center  `}>
						<li className='group relative border-r border-neutral-1 px-3 lg:px-4'>
							<Link
								href='/categories'
								title='Categories'
								target='_self'
						...
						<li className='group relative px-3 lg:px-4 cursor-pointer'>
							<Link
								href='/promotion'
								title='Promotion'
								target='_self'
					...
					<div className='flex items-center gap-4 px-3 lg:px-4'>
						<ModalPhone />
						<ModalUser />
					</div>
				</div>
