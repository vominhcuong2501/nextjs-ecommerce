	...
	return (
		<div className='flex items-center gap-1  relative mt-0'>
			...
			<svg
				...
				viewBox='0 0 24 24'
				fill='none'
				className={` transition-all duration-200 cursor-pointer ${openPhone && 'rotate-180'}`}
				onClick={() => setOpenPhone(!openPhone)}
			>
				<path
					fillRule='evenodd'
			...
			<div
				className={`absolute right-0 -bottom-[285px] p-4 min-w-[250px] bg-neutral-1 shadow-black1 transition-all duration-300 scale-0 rounded-lg  ${
					openPhone && 'scale-100'
				}  before:w-0 before:h-0 before:border-solid before:border-transparent before:border-r-[10px] before:border-l-[10px] before:border-b-[10px] before:border-b-neutral-1  before:absolute before:-top-[10px] before:right-[60px] `}
			>
				<div className='flex items-center justify-between'>
					<p className='text-16 font-bold leading-1-4 text-neutral-8'>+(84)764 713 925</p>
					<svg
						xmlns='http://www.w3.org/2000/svg'
						width='24'
						height='24'
				...
				<ButtonAnimation
					...
					classBackgroundgButton='bg-orange-top-yellow-bottom'
				>
					Request a call
				</ButtonAnimation>
				<div className='flex items-center gap-4 mt-2 border-b border-neutral-11 pb-2'>
				...
				<p className='text-12 text-neutral-7 leading-1-4 font-normal mt-2'>Email:</p>
				<a
				...
				<p className='text-12 text-neutral-7 leading-1-4 font-normal mt-2'>Address:</p>
				<p className='text-12 text-neutral-9 leading-1-4 font-semibold'>
					1 Raffles Place, #40-02, One Raffles Place, Office Tower 1, Singapore
				</p>
			</div>
		</div>
	)
...
const ModalUser = () => {
	return (
		<Link href='/sign-in' title='Sign In' target='_self'>
			<ButtonAnimation
				className={`text-orange-11 hover:text-neutral-1 transition-all duration-300  bg-neutral-1 border-orange-11 hover:border-transparent !py-2`}
				classBackgroundgButton='bg-orange-top-yellow-bottom'
			>
				Sign In
			</ButtonAnimation>
		...
		// 		/>
		// 	</svg>
		// 	<p className='text-14 font-normal leading-1-4 text-neutral-1'>Sign In</p>
		// </div>
	)
}
...
export default function Menu() {
	return (
		<div className='p-4 bg-orange-top-yellow-bottom '>
			<div className='max-w-[1360px] mx-auto '>
				<div className='flex items-center justify-between'>
					<ul className={` flex items-center  `}>
						...
						<li className='group relative px-4 cursor-pointer'>
							<Link
								href='/promotion'
								title='Promotion'
								target='_self'
