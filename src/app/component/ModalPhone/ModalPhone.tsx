	...
	return (
		<div className='flex items-center gap-1  relative mt-0 '>
			...
			<svg
				...
				viewBox='0 0 24 24'
				fill='none'
				className={` transition-all duration-200 cursor-pointer ${isShowPhone && 'rotate-180'}`}
				onClick={() => {
					updateIsShowPhone(!isShowPhone)
					updateIsShowUser(false)
					updateIsShowLang(false)
			...
			<div
				className={`absolute right-0 -bottom-[290px] p-3 min-w-[250px] bg-neutral-1 shadow-black1 transition-all duration-200 scale-0 rounded-lg  ${
			...
			>
				...
				<div className='flex items-center justify-between mt-2 border-b border-neutral-11 pt-2 pb-4'>
					<SocialList />
				</div>
				...
				<a
					...
					className='text-12 text-neutral-8 leading-1-4 font-semibold block hover:text-orange-11 transition-all duration-200'
				>
					minhcuongvo2501@gmail.com
				</a>
				<p className='text-12 text-neutral-7 leading-1-4 font-normal mt-2'>Address:</p>
				<p className='text-12 text-neutral-8 leading-1-4 font-semibold'>
