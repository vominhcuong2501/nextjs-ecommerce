...
export default function Footer() {
	const ItemFirst = () => {
		return (
			<div className=' sm:col-span-3 lg:col-span-2'>
				...
				<p className='text-16 md:text-18 font-bold leading-1-4 text-neutral-8'>International E-commerce Marketplace</p>
				<div className='grid grid-cols-1 gap-2 mt-2 sm:mt-4'>
					<div className='flex items-center gap-2 div-parent-svg-fill group'>
						...
						<a
							...
							className='text-14 font-medium leading-1-4 text-neutral-8 transition-all duration-200 group-hover:text-orange-11 group-hover:font-bold'
						>
							+(84)764 713 925
						</a>
					</div>
					<div className='flex items-center gap-2 div-parent-svg-stroke group'>
						...
						<a
							...
							className='text-14 text-neutral-8 leading-1-4 font-medium block group-hover:text-orange-11 group-hover:font-bold transition-all duration-200'
						>
					...
					<div className='flex items-start gap-2'>
						...
						<p className='text-14 text-neutral-8 leading-1-4 font-medium '>
							469 Nguyen Huu Tho, Tan Hung, Disc 7,
	...
	const ItemSecond = () => {
		return (
			<div>
				<h2 className='text-18 font-bold text-neutral-8 leading-1-4 mt-4'>CATEGORIES</h2>
				<ul className='grid grid-cols-1 gap-2 mt-2 sm:mt-4'>
					<li className='group'>
						<Link
							href={'#'}
	...
	const ItemThird = () => {
		return (
			<div>
				<h2 className='text-18 font-bold text-neutral-8 leading-1-4 mt-4'>LEGAL</h2>
				<ul className='grid grid-cols-1 gap-2 mt-2 sm:mt-4'>
					<li className='group'>
						<Link
							href={'#'}
	...
	const ItemFour = () => {
		return (
			<div>
				<h2 className='text-18 font-bold text-neutral-8 leading-1-4 mt-4'>COMPANY</h2>
				<ul className='grid grid-cols-1 gap-2 mt-2 sm:mt-4'>
					<li className='group'>
						<Link
							href={'#'}
