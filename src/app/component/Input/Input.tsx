	...
	return (
		<div className={className} data-te-input-wrapper-init>
			<div className='relative'>
				<label
					htmlFor={id}
					className={`text-14 lg:text-16 font-normal text-neutral-1 leading-1-4 ${classNameLabel} mb-1 block`}
				>
				...
				<div className='relative'>
					...
					/>
					<div className='absolute left-3 top-[52.5%] -translate-y-1/2'>{iconInput}</div>
